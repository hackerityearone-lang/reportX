    ...
    <section className="mb-16">
      ...
      <Card className="text-center py-12">
        <CardContent>
          ...
          <h4 className="font-semibold text-foreground mb-2">Products Coming Soon</h4>
          <p className="text-muted-foreground">Sign up and create products to see them displayed here</p>
        </CardContent>
      </Card>
    </section>
  )
